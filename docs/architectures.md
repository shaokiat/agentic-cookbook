...
- **Implementation in Cookbook**: See `core/agent.py` and [examples/01_agent_patterns/01_react_basic.py](../examples/01_agent_patterns/01_react_basic.py).
- **Detailed Guide**: [ReAct Basic Agent Documentation](./01_agent_patterns/01_react_basic.md)
...
- **Implementation in Cookbook**: See [examples/01_agent_patterns/02_plan_and_execute.py](../examples/01_agent_patterns/02_plan_and_execute.py).
...
- **Implementation in Cookbook**: See [examples/01_agent_patterns/03_reflexion.py](../examples/01_agent_patterns/03_reflexion.py).
