...
Docs: examples/03_multi_agent_systems/02_parallel_subagents.md
Reference: Nanobot research/nanobot/nanobot/agent/runner.py (concurrent_tools=True), OpenClaw research/openclaw/src/agents/pi-embedded-subscribe.ts (parallel dispatch).
"""
import time
...
def run_aggregator(results: dict[str, str], model: str | None = None,
    ...
    return aggregator.run(f"Synthesize these specialist reports:\n\n{combined}")
